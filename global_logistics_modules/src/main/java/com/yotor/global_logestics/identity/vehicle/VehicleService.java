package com.yotor.global_logestics.identity.vehicle;

import com.yotor.global_logestics.exception.BusinessException;
import com.yotor.global_logestics.exception.ErrorCode;
import com.yotor.global_logestics.identity.domain.user.DriverProfile;
...
import com.yotor.global_logestics.identity.persistence.DriverProfileRepository;
...
import com.yotor.global_logestics.identity.vehicle.dto.CreateVehicleRequest;
...
public class VehicleService {
    ...
    public void createVehicle(CreateVehicleRequest req){
        var driverExternalId = SecurityUtils.currentUser().userExternalId();
        DriverProfile driver = driverRepo.findByUserExternalId(driverExternalId)
    ...
    public void approveVehicle(String vehicleId){
        ...
        Vehicle vehicle = vehicleRepo.findByExternalId(vehicleExternalId)
