...
public class ShipmentController {
    ...
    public ResponseEntity<PageResponse<ShipmentSummary>> getPageOfShipmentsByStage(
            @PathVariable("stage") ShipmentStage stage,
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "10") int size
    ){
        return ResponseEntity.ok(shipmentService.getPageOfShipmentsByStage(stage,page,size));
    }
